...
class Admin extends User {
     ...
     * @return projet créé
     */
    public Project creerProjet(int id, String nom, String description) {
     ...
     */
    public boolean ajouterMembre(Project project, User user) {
     ...
     */
    public boolean attribuerTache(Task task, User user) {
...
class Task {
     ...
     */
    public TaskStatus changerStatut(TaskStatus nouveauStatut) {
    ...
    public boolean assignerUtilisateur(User user) {
        ...
        System.out.println("Tâche assignée à : " + user.nom);
        return true;
    }
}
...
class NotificationService {
    ...
    public boolean notifier(String message) {
        Notification notification = new Notification(1, message, "08/05/2026");
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Création admin
        Admin admin = new Admin(1, "Younes");

        // Création projet
        Project project = admin.creerProjet(1, "Gestion Projet", "Projet UML");

        // Création tâche
        Task task = new Task(1, "Créer diagramme", "Diagramme UML", "10/05/2026");

        // Ajouter tâche au projet
        project.ajouterTache(task);

        // Création membre
        User membre = new User(2, "Ahmed");

        // Ajouter membre
        admin.ajouterMembre(project, membre);

        // Attribuer tâche
        admin.attribuerTache(task, membre);

        // Changer statut
        task.changerStatut(TaskStatus.EN_COURS);
        task.changerStatut(TaskStatus.TERMINEE);

        // Notification
        NotificationService service = new NotificationService();
        service.notifier("Projet mis à jour");
    }
}
